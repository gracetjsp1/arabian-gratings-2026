<div class="row -itealignms-center">
    <div class="col-12 col-md-6 pb-5">
        <h6>1. Steel Access Hatches</h6>
        <div class="access-hatch-overview">
            <p><strong>Overview:</strong> Built to endure heavy use and rugged environments, our steel access hatches
                are perfect for industrial and commercial applications where durability is key.</p>

            <p><strong>Features:</strong></p>
            <ul class="list-unstyled list-items4">
                <li>High strength and resilience, ideal for high-traffic areas</li>
                <li>Corrosion-resistant coatings to withstand weather and wear</li>
                <li>Customizable to specific dimensions and load-bearing requirements</li>
            </ul>

            <p><strong>Ideal For:</strong> Warehouses, factories, and other industrial settings</p>
        </div>
    </div>
    <div class="col-12 col-md-6 pb-5">
    ...
    <div class="col-12 col-md-6 pb-5">
        <h6>2. Stainless Steel Access Hatches</h6>
        <div class="access-hatch-overview">
            <p><strong>Overview:</strong> Stainless steel hatches offer an excellent balance between strength and
                corrosion resistance, suitable for settings where hygiene and longevity are critical.</p>

            <p><strong>Features:</strong></p>
            <ul class="list-unstyled list-items4">
                <li>Rust and corrosion-resistant properties, even in harsh or wet environments</li>
                <li>Hygienic and easy to clean, making it suitable for food and pharmaceutical industries</li>
                <li>Sleek and polished finish for a professional appearance</li>
            </ul>

            <p><strong>Ideal For:</strong> Cleanrooms, hospitals, food processing facilities, and laboratories</p>
        </div>
    </div>
    <div class="col-12 col-md-6 pb-5">
        <h6>3. Aluminium Access Hatches</h6>
        <div class="access-hatch-overview">
            <p><strong>Overview:</strong> Lightweight yet strong, aluminum hatches are well-suited for applications that
                require both durability and ease of handling.</p>

            <p><strong>Features:</strong></p>
            <ul class="list-unstyled list-items4">
                <li>Lightweight design for easier installation and maintenance</li>
                <li>Natural resistance to corrosion, ideal for outdoor applications</li>
                <li>Cost-effective while offering high functionality</li>
            </ul>

            <p><strong>Ideal For:</strong> Commercial buildings, offices, and residential complexes</p>
        </div>
    </div>
    <div class="col-12 col-md-6 pb-5">
